...
maccrobat = spacy.load("relevant_data\maccrobat_model\model-best")
mes = spacy.load("relevant_data\mes_model\model-best")
simple = spacy.load("relevant_data\simple_model\model-best")
